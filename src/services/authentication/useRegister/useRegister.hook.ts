import { IGetExamPayload, IGetExamResponse, IGetExamsHook, IGetExamsQuery } from './useRegister.types'
...
export const useGetExam = (query: IGetExamsHook) => {
  ...
  return useQuery<IGetExamResponse, ErrorResponse, IGetExamResponse, IGetExamsQuery>({
