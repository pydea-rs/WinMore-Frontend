                        ...
                        return (
                          <motion.div
                            ...
                            <motion.div
                              ...
                              {!mineConfig.isGameOver ? (
                                isItemSelected ? (
                                  <Image src={`/assets/games/mine/images/gold.svg`} alt="block" width={50} height={50} />
                                ) : (
                                  <Image src={`/assets/games/mine/images/rock-${blockIndex + 1}.svg`} alt="block" width={50} height={50} />
                                )
                              ) : (
                                <Image src={`/assets/games/mine/images/bomb.svg`} alt="block" width={50} height={50} />
                              )}
                            </motion.div>
                          </motion.div>
                        )
