...
import { IDoneIcon } from './done.types'

const DoneIcon: BaseProps<IDoneIcon> = (props) => {
  ...
  return (
    <svg id="successAnimation" className={classList} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 70 70">
      <path
