...
import { ICentIcon } from './cent.type'
...
const CentIcon: BaseProps<ICentIcon> = (props) => {
  ...
  return (
    <svg className={classList} width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      {/* <path d="M9.08362 14.417L10.1666 13.333V17.667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M9.08667 17.67H11.2467" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /> */}
      <path
